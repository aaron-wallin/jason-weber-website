...
export class DataAccess {
    ...
    getCalendarData(): any {
        // tslint:disable-next-line:max-line-length
        return this._http.get(this._baseCalendarUrl + '&orderBy=startTime&singleEvents=true&timeMin=' + this.fiveDaysBackDateString + '&timeMax=2017-12-31T10:00:00-07:00')
            .map(res => res.json().items);
    }

    getNextEvent(): any {
        // tslint:disable-next-line:max-line-length
        return this._http.get(this._baseCalendarUrl + '&maxResults=1&orderBy=startTime&singleEvents=true&timeMin=' + this.currentDateString + '&timeMax=2017-12-31T10:00:00-07:00')
